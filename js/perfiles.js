...
function getPerfiles(){
    ...
    $.blockUI({ message: '<h4> TRAYENDO PERFILES...</h4>', css: { backgroundColor: null, color: '#fff', border: null } });
...
function modalEditarPerfil(e, id, nombre_perfil, tipo_perfil){
    ...
    $(`#select_editar_tipo_perfil option[value='${tipo_perfil}']`).prop('selected', true);
