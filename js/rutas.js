...
$(document).ready(function () {
  ...
  $("#select_empleados_registrar_0").select2({
    theme: "bootstrap4",
    width: "100%",
    dropdownParent: $("#modal_registrar_ruta"),
  });
  $("#select_empleados_editar_0").select2({
    theme: "bootstrap4",
    width: "100%",
    dropdownParent: $("#modal_editar_ruta"),
  });
});
...
btn_agregar_empleado.click(function (e) {
  ...
  $(`#select_empleados_registrar_${x}`).select2({
    theme: "bootstrap4",
    width: "100%",
    dropdownParent: $("#modal_registrar_ruta"),
  });
...
btn_editar_agregar_empleado.click(function (e) {
  ...
  $(`#select_empleados_editar_${y}`).select2({
    theme: "bootstrap4",
    width: "100%",
    dropdownParent: $("#modal_editar_ruta"),
  });
    ...
    success: function (response) {
      if (response.status == "success") {
        ...
        for (var i = 0; i < response.data.length; i++) {
          ...
          if (rutaEmpleado != "") {
            $(`.select_empleados_editar option[name='${rutaEmpleado}']`).attr(
              "selected",
              "selected"
            );
          }
...
function modalEditarRuta(e, id, empleados, empleados_id, nombre_ruta) {
  ...
  $("#modal_body_editar_ruta")
    .children()
    .not("#contenedor_inp_editar_nombre_ruta")
    .empty();
  $("#modal_body_editar_ruta").append(`
        <div class="form-group mt-2">
  ...
  for (var i = 0; i < empleados_id.split(",").length; i++) {
    ...
    $(`#select_empleados_editar_${i}`).select2({
      theme: "bootstrap4",
      width: "100%",
      dropdownParent: $("#modal_editar_ruta"),
    });
  ...
  if (
    $(".select_empleados_editar").toArray().length >
    empleados_id.split(",").length
  ) {
...
btn_guardar_ruta.click(function () {
  ...
  for (var i = 0; i < $(".select_empleados").toArray().length; i++) {
    if (
      inp_nombre_ruta.val() == "" ||
      $(`#select_empleados_registrar_${i} option:selected`).val() == 0
    ) {
      Swal.fire({
        icon: "warning",
        title: "Campos vacíos",
...
btn_guardar_editar_ruta.click(function () {
  ...
  for (var i = 0; i < $(".select_empleados_editar").toArray().length; i++) {
    if (
      inp_editar_nombre_ruta.val() == "" ||
      $(`#select_empleados_editar_${i} option:selected`).val() == 0
    ) {
      Swal.fire({
        icon: "warning",
        title: "Campos vacíos",
